...
//     host: "smtp.gmail.com",
//     port: 465,
//     secure: true, // Use SSL for security
//     auth: {
...
//   try {
//     await transport.sendMail({
//       from: `"E-Learning Platform" <${process.env.GMAIL_USER}>`,
//       to: email,
//       subject,
//       html: htmlContent,
//     });
...
// // OTP Mail Function
// export const sendOTP = async (email, data) => {
//   const htmlContent = `
//     <!DOCTYPE html>
//     <html lang="en">
//     <head>
...
//       <div class="container">
//         <h1>OTP Verification</h1>
//         <p>Hello ${data.name}, your One-Time Password (OTP) for verification is:</p>
//         <p class="otp">${data.otp}</p>
//       </div>
//     </body>
//     </html>
...
//   await sendMail(email, "OTP Verification", htmlContent);
// };
...
//                     box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1); max-width: 600px; }
//         h1 { color: #5a2d82; }
//         .button { display: inline-block; padding: 15px 25px; margin: 20px 0;
//                   background-color: #5a2d82; color: white; text-decoration: none; 
//                   border-radius: 4px; }
//         .footer { margin-top: 20px; color: #999999; text-align: center; }
//       </style>
//     </head>
//     <body>
//       <div class="container">
...
//   await sendMail(data.email, "Password Reset Request", htmlContent);
// };
